      ...
      <div className="flex items-center justify-between">
        ...
        {showAuthButtons && (
          <div className="flex items-center space-x-2 lg:space-x-4">
            ...
            <button className="px-3 lg:px-4 py-2 bg-[var(--bg-input)] text-[var(--text-secondary)] rounded-xl border border-[var(--border-primary)] hover:bg-[var(--border-primary)] transition-colors flex items-center space-x-2" style={{ background: 'var(--btn-gradient)' }}>
